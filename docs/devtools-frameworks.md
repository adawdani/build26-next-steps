...
| BRK201: Multi-agent patterns in VS Code you won't learn from docs | Julia Kasper, Harald Kirschner, Burke Holland |
| BRK202: Azure DevOps meets GitHub, the path to AI powered SDLC | Dan Hellem, [Dave Burnison](https://build.microsoft.com/en-US/speakers/1768245294609build26-1774649238388001v8Ts?source=/speakers) |
| BRK203: From CLI to PR: Automating the path to merged code | Cassidy Williams, Evan Boyle |
| BRK204: What we learned shipping VS Code weekly (without breaking everything) | Peng Lyu, [Pierce Boggan](https://build.microsoft.com/en-US/speakers/1768245294609build26-1775704791363001hLZq?source=/speakers) |
| BRK205: Aspire for agents: Transform how you build and deploy distributed apps | Damian Edwards, David Fowler |
| BRK206: Your agent, anywhere: MultiClient, MultiDevice with GitHub Copilot SDK | Patrick Nikoletich, Steve Sanderson |
| DEM300: Supercharged profiling: Finding performance bugs with agents | Nik Karpinsky |
| DEM301: Rethinking CI: Actions, AI Agents, and the End of Commit-Fail-Commit | Salil Subbakrishna, Denizhan Yigitbas |
| DEM302: Build and deploy an Azure app with your agent team | Rong Lu, Mandy Whaley |
| DEM303: Late to agentic coding? Don’t panic, build. | Cassidy Williams, Martin Woodward |
| DEM304: Union types in C# | Dustin Campbell, Mads Torgersen |
| DEM305: GitHub Copilot Anywhere: From CLIs to Cloud Execution Environments | Ellie Bennett, Denizhan Yigitbas |
| DEM365: Beyond REST: .NET Apps That Talk to Hardware | Jared Rhodes |
